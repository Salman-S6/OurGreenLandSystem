...
class AgriculturalAlertPolicy
{
     ...
     */
    public function restore(User $user, AgriculturalAlert $agriculturalAlert): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, AgriculturalAlert $agriculturalAlert): bool
    {
        return false;
    }
}
