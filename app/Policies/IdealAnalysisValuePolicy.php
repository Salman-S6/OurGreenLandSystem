...
class IdealAnalysisValuePolicy
{
     ...
     */
    public function restore(User $user, IdealAnalysisValue $idealAnalysisValue): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, IdealAnalysisValue $idealAnalysisValue): bool
    {
        return false;
    }
}
