...
class ProductionEstimationPolicy
{
     ...
     */
    public function restore(User $user, ProductionEstimation $productionEstimation): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, ProductionEstimation $productionEstimation): bool
    {
        return false;
    }
}
