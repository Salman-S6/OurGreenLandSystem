...
class AgriculturalInfrastructurePolicy
{
     ...
     */
    public function restore(User $user, AgriculturalInfrastructure $agriculturalInfrastructure): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, AgriculturalInfrastructure $agriculturalInfrastructure): bool
    {
        return false;
    }
}
