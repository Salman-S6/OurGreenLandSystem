...
class InputDeliveryStatusPolicy
{
     ...
     */
    public function restore(User $user, InputDeliveryStatus $inputDeliveryStatus): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, InputDeliveryStatus $inputDeliveryStatus): bool
    {
        return false;
    }
}
